...
class FiscalPeriodsTest {
    ...
    @Test
    void periodsByGivenType() throws Exception {
        ...
        assertThat(annualPeriod1.balanceSheet().value("B1").value()).isEqualByComparingTo("2.0");
        assertThat(annualPeriod1.incomeStatement().date()).isEqualTo("2019-12-31");
        assertThat(annualPeriod1.incomeStatement().value("I1").value()).isEqualByComparingTo("1.0");
        var annualPeriod2 = annualIterator.next();
        assertThat(annualPeriod2.balanceSheet().date()).isEqualTo("2018-12-31");
        assertThat(annualPeriod2.balanceSheet().value("B2").value()).isEqualByComparingTo("3.0");
        assertThat(annualPeriod2.incomeStatement().date()).isEqualTo("2018-12-31");
        assertThat(annualPeriod2.incomeStatement().value("I2").value()).isEqualByComparingTo("4.0");
        ...
        assertThat(interimPeriod1.balanceSheet().value("B3").value()).isEqualByComparingTo("6.0");
        assertThat(interimPeriod1.incomeStatement().date()).isEqualTo("2019-03-31");
        assertThat(interimPeriod1.incomeStatement().value("I3").value()).isEqualByComparingTo("5.0");
        var interimPeriod2 = interimIterator.next();
        assertThat(interimPeriod2.balanceSheet().date()).isEqualTo("2018-09-30");
        assertThat(interimPeriod2.balanceSheet().value("B4").value()).isEqualByComparingTo("7.0");
        assertThat(interimPeriod2.incomeStatement().date()).isEqualTo("2018-09-30");
        assertThat(interimPeriod2.incomeStatement().value("I4").value()).isEqualByComparingTo("8.0");
